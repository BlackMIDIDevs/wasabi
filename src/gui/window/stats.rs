                        ...
                        Statistics::Fps => {
                            ui.horizontal(|ui| {
                                ...
                                ui.with_layout(
                                    egui::Layout::right_to_left(egui::Align::Center),
                                    |ui| {
                                        ui.monospace(format!("{}", f.fmt2(self.fps.get_fps())));
                                    },
                                );
                            });
                        }
                            ...
                            if let Some(voice_count) = stats.voice_count {
                                ui.horizontal(|ui| {
                                    ...
                                    ui.with_layout(
                                        egui::Layout::right_to_left(egui::Align::Center),
                                        |ui| {
                                            ui.monospace(format!("{}", f.fmt2(voice_count)));
                                        },
                                    );
                                });
                            }
                        ...
                        Statistics::Rendered => {
                            ui.horizontal(|ui| {
                                ...
                                ui.with_layout(
                                    egui::Layout::right_to_left(egui::Align::Center),
                                    |ui| {
                                        ui.monospace(format!("{}", f.fmt2(stats.notes_on_screen)));
                                    },
                                );
                            });
                        }
                            ...
                            ui.horizontal(|ui| {
                                ...
                                ui.with_layout(
                                    ...
                                    |ui| {
                                        ...
                                        ui.monospace(format!("{}", f.fmt2(self.nps.read())));
                                    },
                                );
                            });
                        }
                            ...
                            if let Some(poly) = stats.polyphony {
                                ui.horizontal(|ui| {
                                    ...
                                    ui.with_layout(
                                        egui::Layout::right_to_left(egui::Align::Center),
                                        |ui| {
                                            ui.monospace(format!("{}", f.fmt2(poly)));
                                        },
                                    );
                                });
                            }
